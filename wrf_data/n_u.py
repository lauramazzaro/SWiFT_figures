...
xmin = datetime.datetime(2013,11,8,21,30,0,0)
xmax = datetime.datetime(2013,11,8,23,0,0,0)
...
plt.savefig('n_u.png',dpi=600)
plt.show()

# Data is cropped to right time period and saved manually
#np.savez('neutral_data.npz',t_t=t_t,t_xy=t_xy,t_z=t_z,t_u=t_u,u_t=u_t,u_xy=u_xy,u_z=u_z,u_u=u_u,v_t=v_t,v_xy=v_xy,v_z=v_z,v_u=v_u)
