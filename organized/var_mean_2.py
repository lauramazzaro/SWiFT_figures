...
#t_z = np.append(t_xy,dh['t_z'],axis=0)
#t_u = np.append(t_xy,dh['t_u'],axis=0)
#t_t = np.append(t_xy,dh['t_t'],axis=0)
#
#u_xy = np.append(u_xy,dh['u_xy'],axis=0)
#u_z = np.append(u_xy,dh['u_z'],axis=0)
#u_u = np.append(u_xy,dh['u_u'],axis=0)
#u_t = np.append(u_xy,dh['u_t'],axis=0)
#
#v_xy = np.append(v_xy,dh['v_xy'],axis=0)
#v_z = np.append(v_xy,dh['v_z'],axis=0)
#v_u = np.append(v_xy,dh['v_u'],axis=0)
#v_t = np.append(v_xy,dh['v_t'],axis=0)
#
#U_t = ((u_t)**2+(v_t)**2)**(1/2.)
#U_u = ((u_u)**2+(v_u)**2)**(1/2.)
#U_z = ((u_z)**2+(v_z)**2)**(1/2.)
