...
plt.text(1.6,0.6,R'$\mathregular{{N}_{NP}}$',fontsize=24,color='black')
plt.text(2,0.6,R'$\mathregular{{N}_{xy1000}}$',fontsize=24,color=line_cols[0])
plt.text(2.4,0.6,R'$\mathregular{{N}_{xy5000}}$',fontsize=24,color=line_cols[1])
...
plt.savefig('00_neutral.png', dpi=600)
